                        ...
                        'Я хотел бы попробоать вашу фирменную содавую и ,наверное, возьму ещё кока колу.'
                            ...
                            'В таком случае я возьму 1 л Кока Колы, 1 л Содавай и 0,5 л Пепси Колы.'
                                ...
                                'Ленинградское шоссе, д. 47, кв. 58'
                                    ...
                                    res['response']['text'] = 'Ваш заказ собран. Сумма заказа 2375 рублей, оплатить можно картой. Через какой сервис вы желаете оплатить покупку?'
                            ...
                            'Из этого списка я возьму Содавую и Пепси Колу.'
                                ...
                                'В таком случае я возьму 0,8 л Пепси Колы и 1 л Содавай.'
                                    ...
                                    'Я предпочитаю оплату наличными'
                                        ...
                                        res['response']['text'] = 'Номер вашего заказа: 482093, явится за ним можно будет по адресу нашей пиццерии, его можно узнать на нашем официальном сайте: https://google.pizza.ru/search?text=пицца'
